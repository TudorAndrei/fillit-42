...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/02 20:54:36 by tdumitra          #+#    #+#             */
/*   Updated: 2018/02/03 15:47:37 by tdumitra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_solver(char **row, char ***tetra, int b)
{
	int i;
	int j;
